  ...
  <!-- <div class="container mt-5"> -->
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-gradient" style="background-color: #e3f2fd;">
      <div class="container-fluid">
        <h1 style="color: #363062">Update CV</h1>
        <a class="navbar-brand" href="/cv" style="color: #001B79">View</a>
      </div>
    </nav>
    <div class="card">
      <div class="p-3">
        <div class="card-body">
          <form method="post">
            <div class="mb-3">
              ...
              <label for="telepon" class="form-label font-weight-bold">Telepon</label>
              ...
              <label for="web" class="form-label font-weight-bold">Web</label>
              <input class="form-control" id="web" type="text" name="web" value="<?php echo $data['web']; ?>" placeholder="Web" required>
              <label for="pendidikan" class="form-label font-weight-bold">Pendidikan</label>
              ...
              <label for="pengalamanKerja" class="form-label font-weight-bold">Pengalaman Kerja</label>
              ...
              <label for="keterampilan" class="form-label font-weight-bold">Keterampilan</label>
              ...
              <label for="formFile" class="form-label font-weight-bold">Foto Path</label>
